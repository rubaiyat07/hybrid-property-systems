<header class="owner-header flex justify-between items-center px-8 py-4">
    ...
    <nav class="nav-links flex items-center gap-6">
        ...
        @role('Tenant')
            ...
            <a href="{{ route('tenant.leases.index') }}" class="relative font-medium text-black hover:text-indigo-400 transition">My Leases</a>
            <a href="{{ route('tenant.payments.index') }}" class="relative font-medium text-black hover:text-indigo-400 transition">Payments</a>
        @endrole
