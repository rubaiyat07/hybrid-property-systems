                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                        @if($application['type'] === 'inquiry')
                                            @if($application['data']->status === 'approved') bg-green-100 text-green-800
                                            @else bg-blue-100 text-blue-800 @endif
                                        @else bg-purple-100 text-purple-800 @endif">
                                        @if($application['type'] === 'inquiry')
                                            @if($application['data']->status === 'approved') Approved - Waiting for Payment
                                            @else Inquiry @endif
                                        @else Lead @endif
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @if($application['type'] === 'inquiry')
                                        @if($application['data']->inquiry_type === 'booking_request')
                                            <a href="{{ route('landlord.leases.create', ['inquiry_id' => $application['data']->id]) }}" class="text-green-600 hover:text-green-900 mr-2" title="Approve">
