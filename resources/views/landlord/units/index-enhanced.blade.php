{{-- File: resources/views/landlord/units/index-enhanced.blade.php --}}
...
<div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white shadow rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $units->where('is_published', true)->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg p-4 mb-6">
        <form method="GET" action="{{ route('landlord.units.index') }}" class="flex flex-wrap gap-4">
            ...
            <div>
                <label for="listing_status" class="block text-sm font-medium text-gray-700 mb-1">Listing Status</label>
                <select name="listing_status" id="listing_status"
                        class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    <option value="">All Listings</option>
                    <option value="published" {{ request('listing_status') == 'published' ? 'selected' : '' }}>Published</option>
                    <option value="unpublished" {{ request('listing_status') == 'unpublished' ? 'selected' : '' }}>Unpublished</option>
                </select>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($unit->is_published)
                                        ...
                                        <div class="mt-1">
                                            <button onclick="unpublishUnit({{ $unit->id }})"
                                    ...
                                    @else
                                        ...
                                        <div class="mt-1">
                                            <button onclick="publishUnit({{ $unit->id }})"
