...
@section('content')
<h1 class="text-2xl font-bold mb-4">My Taxes</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">
                ...
                <form method="POST" action="{{ route('tenant.taxes.upload-receipt', $tax->id) }}" enctype="multipart/form-data">
                    @csrf
                ...
                @elseif($tax->receipt_path)
                    <a href="{{ route('tenant.taxes.download', $tax->id) }}" class="text-blue-600 hover:underline">Download Receipt</a>
                @endif
            </td>
        </tr>
        @endforeach
