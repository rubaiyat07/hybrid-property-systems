    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border px-4 py-2">
                ...
                <form method="POST" action="{{ route('tenant.bills.pay', $bill->id) }}" enctype="multipart/form-data">
                    @csrf
                ...
                @elseif($bill->receipt_path)
                    <a href="{{ route('tenant.bills.download', $bill->id) }}" class="text-blue-600 hover:underline">Download Receipt</a>
                @endif
            </td>
        </tr>
        @endforeach
