...
class AdminController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        $pendingScreenings = TenantScreening::where('status', 'pending')->count();
        $pendingTaxes = PropertyTax::where('status', 'pending')->count();
        $pendingBills = PropertyBill::where('status', 'pending')->count();
        $pendingDocuments = PropertyDocument::where('status', 'pending')->count();
        $pendingTransfers = PropertyTransfer::where('status', 'pending')->count();
