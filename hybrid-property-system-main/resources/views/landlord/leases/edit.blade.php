    ...
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('landlord.leases.show', $lease) }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('landlord.leases.update', $lease) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                @if($lease->document_path)
                    <div class="mt-6">
                        ...
                        <div class="flex items-center justify-between bg-gray-50 p-3 rounded">
                            ...
                            <a href="{{ route('landlord.leases.download-document', $lease) }}" class="text-blue-600 hover:text-blue-800">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <a href="{{ route('landlord.leases.show', $lease) }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400 transition-colors">
                        Cancel
                    </a>
